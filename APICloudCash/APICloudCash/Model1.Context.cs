...
namespace APICloudCash
{
    ...
    public partial class DBCC : DbContext
    {
        ...
        public virtual ObjectResult<string> SP_CrearTarjetaCredito(Nullable<long> id_Cliente, Nullable<long> numeroTarjeta, string nombrePoseedor, Nullable<System.DateTime> fechaVencimiento, Nullable<short> cvc, Nullable<long> saldo, Nullable<int> id_TipoDivisa, Nullable<bool> activa)
        {
            ...
            var numeroTarjetaParameter = numeroTarjeta.HasValue ?
                ...
                new ObjectParameter("numeroTarjeta", typeof(long));
        ...
        public virtual ObjectResult<string> SP_CrearTarjetaDebito(Nullable<long> id_Cliente, Nullable<long> numeroTarjeta, string nombrePoseedor, Nullable<System.DateTime> fechaVencimiento, Nullable<short> cvc, Nullable<long> saldo, Nullable<int> id_TipoDivisa, Nullable<bool> activa)
        {
            var id_ClienteParameter = id_Cliente.HasValue ?
                new ObjectParameter("id_Cliente", id_Cliente) :
                new ObjectParameter("id_Cliente", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SP_CrearTarjetaDebito", id_ClienteParameter, numeroTarjetaParameter, nombrePoseedorParameter, fechaVencimientoParameter, cvcParameter, saldoParameter, id_TipoDivisaParameter, activaParameter);
        }
